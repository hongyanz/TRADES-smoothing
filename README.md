...
```bash
  ...
  $ python code/certify_trades_dim.py cifar10 --imagesize 32 --sigma 0.12 'results/output_noise12_size32_l2trades0435_beta6_full' --skip 1 --batch 10000 --load_dir './model_noise12_size32_l2trades0435_beta6/model-wideres-epoch.pt'
```
