...
if __name__ == "__main__":
    plot_certified_accuracy(
        "vary_dim_cifar10_trades", "CIFAR-10, cifar-res110", 0.01, [
            Line(ApproximateAccuracy("output_noise12_size32_l2trades0435_beta6"), "Size 32"),
            Line(ApproximateAccuracy("output_noise18_size48_l2trades06525_beta6"), "Size 48"),
            Line(ApproximateAccuracy("output_noise24_size64_l2trades087_beta6"), "Size 64"),
        ], radius_step=0.001/np.sqrt(3*32*32))